...
public class ChestEquipment
{
    public int bonusHP, bonusMP, bonusATK, bonusMAG, bonusATKSPD, bonusMOVSPD, bonusRange;
    public string name;

    public ChestEquipment(string name, int bonusHP, int bonusMP, int bonusATK, int bonusMAG, int bonusATKSPD, int bonusMOVSPD, int bonusRange) {
        this.name = name;
